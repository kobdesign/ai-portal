    ...
    <div className="h-full flex flex-col bg-[#111113] overflow-hidden">
      ...
      <div className="p-6 border-b border-[#27272a] bg-[#18181b] shrink-0">
        <h1 className="text-2xl font-bold text-white mb-2 flex items-center gap-3">
          ...
          <Badge className="bg-indigo-500/20 text-indigo-400 border-indigo-500/30 hover:bg-indigo-500/20">
            C-Level View
          </Badge>
        </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="bg-[#18181b] border-[#27272a]">
                <CardContent className="p-5">
                  ...
                  <div className="text-2xl font-bold text-white mb-2">
                    $4,250 <span className="text-xs text-slate-500 font-normal">/ month</span>
                  </div>
              ...
              <Card className="bg-[#18181b] border-[#27272a]">
                <CardContent className="p-5">
                  ...
                  <div className="text-2xl font-bold text-white mb-2">
                    -$2,100 <span className="text-xs text-slate-500 font-normal">savings</span>
                  </div>
              ...
              <Card className="bg-[#18181b] border-[#27272a] border-l-4 border-l-emerald-500">
                <CardContent className="p-5">
                  ...
                  <div className="text-2xl font-bold text-white mb-2">
                    3.5x <span className="text-xs text-slate-500 font-normal">faster</span>
                  </div>
                  <div className="text-xs text-slate-400">
              ...
              <Card className="bg-[#18181b] border-[#27272a]">
                <CardContent className="p-5">
                  <h3 className="text-sm font-medium text-slate-200 mb-4">
                    Team AI Fluency (Prompt Engineering)
                  </h3>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-slate-500">
                            High efficiency (1.2 prompts/feature)
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-slate-500">
                            AI Tutor assigned for Security Ops
                          </div>
                        </div>
                      </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-slate-400 max-w-2xl mb-4">
                  ป้องกันปัญหา Microservices Hell ด้วยการมองเห็นความเชื่อมโยงของระบบทั้งหมด
                  (Topology Map) พร้อมระบบแจ้งเตือนผลกระทบ (Blast Radius) ก่อนให้ AI แก้ไขโค้ด
                </p>
                <Button
              ...
              <div className="hidden md:flex flex-col gap-2 opacity-50">
                <div className="flex items-center gap-2 text-xs text-slate-300 bg-black/40 px-3 py-1.5 rounded border border-white/5">
                  <Cpu size={12} /> API Gateway
                </div>
                <div className="flex justify-center">
                  <ArrowRight size={12} className="text-slate-500 rotate-90" />
                </div>
                <div className="flex items-center gap-2 text-xs text-slate-300 bg-black/40 px-3 py-1.5 rounded border border-white/5">
                  <ShieldAlert size={12} /> Auth Service
                </div>
              </div>
            </div>
          </section>
