          ...
          <div className="space-y-2">
            ...
            >
              <div className="font-medium text-sm flex items-center gap-2">
                <Zap size={14} /> Identity & Access (SSO)
              </div>
            ...
            >
              <div className="font-medium text-sm flex items-center gap-2">
                <Database size={14} /> Legacy Mainframe
              </div>
        ...
        <div className="flex-1 relative bg-[#111113] overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="absolute top-6 left-6 z-20">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Interactive view of all microservices and legacy systems
            </p>
          </div>
          ...
          <div className="relative z-10 w-full max-w-[800px] h-[600px] flex flex-col items-center justify-center scale-125">
            ...
            <div className="flex justify-center gap-16 mb-20">
              ...
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 bg-[#18181b] border-[#3f3f46] text-slate-300 text-sm font-medium shadow-lg">
            ...
            <div className="flex justify-center gap-24 mb-20 w-full">
              ...
              >
                {selectedNode !== "api1" && (
                  <div className="absolute -top-2 -right-2 w-4 h-4 bg-amber-500 rounded-full animate-pulse border-2 border-[#111113]"></div>
                )}
                <Cpu size={24} className={selectedNode === "api1" ? "" : "text-amber-500"} />
                <span>Core Banking API</span>
                <Badge
                  variant="outline"
                  className="text-[10px] h-5 bg-black/40 border-amber-500/30 text-amber-500"
                >
                  High Load
                </Badge>
              </div>
              ...
              >
                ...
                <Badge
                  variant="outline"
                  className="text-[10px] h-5 bg-black/40 border-indigo-500/30 text-indigo-400"
                >
                  Hub Node
                </Badge>
              </div>
            ...
            <div className="flex justify-center gap-20 w-full">
              ...
              <div className="flex items-center gap-3 px-5 py-3 rounded-xl border-2 bg-[#18181b] border-[#3f3f46] text-slate-300 text-sm font-medium shadow-lg opacity-60">
                <div className="w-10 h-10 bg-slate-800 rounded flex items-center justify-center">
          ...
          <div className="absolute bottom-6 right-6 flex items-center gap-4 bg-[#18181b] p-3 rounded-xl border border-[#27272a] shadow-2xl">
            ...
            <span className="flex items-center gap-1.5 text-xs text-slate-400">
              <span className="w-2 h-2 rounded-full bg-emerald-500"></span> Healthy DB
            </span>
            <span className="flex items-center gap-1.5 text-xs text-slate-400">
              <span className="w-2 h-2 rounded-full bg-indigo-500"></span> Core Hub
            </span>
            <span className="flex items-center gap-1.5 text-xs text-slate-400">
              <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse"></span> Warning
            </span>
            <span className="flex items-center gap-1.5 text-xs text-slate-400 ml-2">
              <svg width="24" height="6">
                <path d="M 0,3 L 24,3" stroke="#6b7280" strokeWidth="2" strokeDasharray="4 4" />
              </svg>{" "}
              Asynchronous
            </span>
          </div>
