        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <main className="flex-1 flex w-full h-full border-l border-border/40">
            <ResizablePanelGroup direction="horizontal">
              <ResizablePanel defaultSize={35} minSize={25} maxSize={50} className="bg-[#111113]">
                  ...
                  <div className="h-full flex flex-col bg-background/50">
                    <div className="p-4 border-b border-border/40 bg-card">
                      <h2 className="text-lg font-semibold mb-1 flex items-center gap-2">
                        Code & Legacy Sync
                        <span className="px-1.5 py-0.5 text-[10px] bg-amber-500/20 text-amber-400 rounded uppercase font-bold tracking-wider">
                          Enterprise
                        </span>
                      </h2>
                      <p className="text-sm text-muted-foreground">
                        เชื่อมต่อ Repository ภายในองค์กรหรืออัปโหลดโค้ดระบบเก่าให้ AI วิเคราะห์
                      </p>
                    </div>
                    ...
                    <div className="p-4 space-y-6 flex-1 overflow-y-auto">
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-col gap-2">
                          <Input
                            placeholder="https://gitlab.internal.company.com/project.git"
                            className="bg-[#18181b] border-border/60 text-sm"
                          />
                          <Input
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          อัปโหลด Source code จากระบบเก่า (เช่น SVN, AS/400, PHP เก่า) ให้ AI
                          เรียนรู้และ Refactor เป็น Modern Stack
                        </p>
                        <div className="border-2 border-dashed border-border/60 rounded-xl p-6 flex flex-col items-center justify-center text-center bg-[#18181b] hover:bg-muted/30 transition-colors cursor-pointer group">
                          <FileArchive
                            size={28}
                            className="text-muted-foreground group-hover:text-amber-400 mb-2 transition-colors"
                          />
                          <span className="text-sm font-medium text-foreground">
                            Drag & Drop codebase zip here
                          </span>
                ...
                {activeSidebar === "data" && (
                  <div className="h-full flex flex-col p-6 text-center items-center justify-center bg-background/50">
                    ...
                    <p className="text-sm text-muted-foreground max-w-[250px] mb-6">
                      เชื่อมต่อฐานข้อมูล On-Premise ขององค์กรอย่างปลอดภัยผ่าน Secure Tunnel (Oracle,
                      MS SQL, DB2)
                    </p>
                ...
                {activeSidebar === "security" && (
                  <div className="h-full flex flex-col p-6 text-center items-center justify-center bg-background/50">
                    ...
                    <p className="text-sm text-muted-foreground max-w-[250px] mb-6">
                      ตรวจสอบโค้ดและการจัดการข้อมูลให้สอดคล้องกับ พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล
                      (PDPA) อัตโนมัติ
                    </p>
              ...
              <ResizableHandle
                withHandle
                className="bg-border/40 hover:bg-sky-500/50 transition-colors w-[2px]"
              />
