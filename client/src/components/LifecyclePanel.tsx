        ...
        {steps.map((step, idx) => {
          ...
          return (
            <div key={step.id} className="relative z-10 flex flex-col items-center group cursor-pointer">
              ...
              <span className={`absolute top-8 text-[9px] font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity ${isActive ? 'text-purple-400 opacity-100' : 'text-muted-foreground'}`}>
                {step.name}
              </span>
            </div>
          );
      ...
      <div className="p-4 border-b border-border/40 bg-card">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex gap-2">
            <Button size="sm" variant="outline" className="h-7 text-xs px-2.5 border-border/60 hover:bg-muted/50">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-xs mt-2">
                      <Badge variant="outline" className="bg-sky-500/10 text-sky-400 border-sky-500/30 text-[9px] h-5 hover:bg-sky-500/20 cursor-pointer transition-colors">
