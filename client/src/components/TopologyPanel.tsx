    ...
    <div className="h-full flex flex-col bg-background/50">
      <div className="p-4 border-b border-border/40 bg-card">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          แผนผังแสดงความเชื่อมโยงของระบบทั้งหมด (Architecture Dependency)
          และวิเคราะห์ผลกระทบก่อนแก้ไขโค้ด
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
            ...
            <p className="text-xs text-amber-400/80 leading-relaxed mb-3">
              การให้ AI แก้ไขโครงสร้าง Database <code>User Auth DB</code> ในโปรเจกต์นี้
              จะส่งผลกระทบต่อ 2 ระบบอื่นที่กำลังเชื่อมต่ออยู่
            </p>
            <div className="space-y-2">
              <div className="flex items-center justify-between bg-black/20 p-2 rounded border border-amber-500/20 text-xs">
                ...
                <Badge
                  variant="outline"
                  className="text-[9px] h-4 border-amber-500/30 text-amber-500"
                >
                  High Impact
                </Badge>
              </div>
            ...
            <Button
              size="sm"
              className="w-full mt-3 h-7 bg-amber-500/20 hover:bg-amber-500/30 text-amber-400 text-xs"
            >
            ...
            <div className="bg-[#18181b] border border-border/40 rounded-xl p-4 relative min-h-[300px] flex flex-col items-center justify-center overflow-hidden">
              ...
              <div className="relative z-10 w-full max-w-[280px]">
                ...
                <div className="flex justify-between mb-8">
                  ...
                  >
                    <Cpu size={14} className={selectedNode === "api1" ? "" : "text-amber-500"} />{" "}
                    Core Banking API
                  </div>
                  <div
