...
export function SpecPanel() {
  const { setActiveSpec } = useChatContext();
  return (
      ...
      <div className="p-4 border-b border-border/40 bg-card">
        <div className="flex items-center justify-between mb-1">
          <h2 className="text-lg font-semibold flex items-center gap-2">
            Project Specs
            <span className="px-1.5 py-0.5 text-[10px] bg-sky-500/20 text-sky-400 rounded uppercase font-bold tracking-wider">
              OpenSpec
            </span>
          </h2>
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mt-2">
          จัดการ Requirement สั่ง AI ให้พัฒนาโค้ดตาม Spec และติดตามว่า Spec ถูกใช้งานใน Lifecycle
          ขั้นตอนไหน
        </p>
      </div>
        ...
        <div className="space-y-4">
            ...
            <div className="px-4 py-3 bg-card/50 border-b border-border/40 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-medium text-sm text-foreground">
                  EPIC-01: Authentication Module
                </h3>
              </div>
              <div className="flex items-center gap-2">
                <Badge
                  variant="outline"
                  className="text-[9px] h-5 bg-purple-500/10 text-purple-400 border-purple-500/30 flex items-center gap-1 cursor-pointer hover:bg-purple-500/20"
                >
              ...
              <div className="p-3 hover:bg-muted/30 transition-colors group bg-sky-500/5 relative overflow-hidden">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex gap-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <Badge
                          variant="secondary"
                          className="text-[9px] h-4 bg-purple-500/20 text-purple-300 border-none"
                        >
                          <Code2 size={10} className="mr-1" /> Lifecycle: Implementing
                        </Badge>
                        <Badge
                          variant="outline"
                          className="text-[9px] h-4 text-sky-300 border-sky-500/20"
                        >
                          Security
                        </Badge>
                      </div>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <Button
                      size="sm"
                      className="h-7 text-[11px] bg-sky-600 hover:bg-sky-700 w-full"
                      onClick={() =>
                        setActiveSpec({
                          id: "US-101",
                          name: "Corporate SSO Login",
                          description: "ผู้ใช้สามารถ Login เข้าสู่ระบบด้วย Azure AD ของบริษัทได้",
                        })
                      }
                    >
                  ...
                  <div className="flex gap-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <Badge
                          variant="outline"
                          className="text-[9px] h-4 border-border/60 text-muted-foreground"
                        >
          ...
          <div className="bg-[#18181b] border border-border/40 rounded-xl overflow-hidden opacity-70 hover:opacity-100 transition-opacity">
            <div className="px-4 py-3 bg-card/50 border-b border-border/40 flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className="text-[10px] h-5 bg-slate-500/10 text-slate-400 border-slate-500/20"
              >
                Not Started
              </Badge>
            </div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-7 text-xs border-sky-500/30 text-sky-400 hover:bg-sky-500/10"
                    >
                      Start Feature Loop
                    </Button>
                  </div>
