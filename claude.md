...
_เป้าหมาย: ให้ AI รู้จัก "บริบทขององค์กร" ก่อนเริ่มเขียนโค้ด_
...
2. **ใส่คู่มือองค์กร (Enterprise Knowledge)**
   ...
   - _ผลลัพธ์: AI จะไม่มั่วโค้ดเอง แต่จะเขียนโค้ดอิงตามมาตรฐานขององค์กร_
...
_เป้าหมาย: เปลี่ยน Requirement เป็นโค้ดอย่างเป็นระบบ ไม่สะเปะสะปะ_
...
- _เช่น EPIC-01: ระบบ Authentication -> US-101: Login ด้วย Azure AD_
...
- _ตัวอย่าง: ฟีเจอร์ "ระบบ Login" ตอนนี้อยู่สถานะ "Implement" (กำลังเขียนโค้ด)_

### Step 3: สั่ง AI ให้ทำงาน (ที่เมนู Agent/Chat)

- Developer เปิดหน้า **Agent (Chat)** ขึ้นมา
- หน้าต่างแชทจะแสดง **"Active Context"** ให้เห็นเลยว่า ตอนนี้ AI กำลังโฟกัสที่ _ฟีเจอร์ระบบ Login (Lifecycle)_ โดยอิงตาม _US-101 (Spec)_
...
_เป้าหมาย: ตรวจสอบความถูกต้องและขึ้น Production อย่างปลอดภัย_
...
_เป้าหมาย: ขยายการใช้งานแพลตฟอร์มให้บริษัทในเครือ, Vendor หรือลูกค้าภายนอกเข้ามาใช้งานร่วมกันได้อย่างปลอดภัย_
...
_เป้าหมาย: ใช้แพลตฟอร์ม AI นี้ช่วยสร้าง API เส้นใหม่ขึ้นมาอย่างรวดเร็ว ปลอดภัย และเปิดให้ Partner นำไปเชื่อมต่อใช้งานได้ทันที_
...
- สร้าง User Story ระบุว่าต้องการ API ทำอะไร เช่น _"US-301: สร้าง REST API สำหรับดึงคะแนนสะสม (Loyalty Points) ให้ Partner"_
